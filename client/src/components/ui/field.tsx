...
function FieldGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "group/field-group @container/field-group flex w-full flex-col gap-5 data-[slot=checkbox-group]:gap-4 *:data-[slot=field-group]:gap-5",
        className
      )}
      {...props}
    />
...
function FieldSeparator({
  ...
  return (
    <div
      ...
      className={cn(
        "relative -my-1 h-6 text-sm group-data-[variant=outline]/field-group:-mb-1",
        className
      )}
      {...props}
    >
